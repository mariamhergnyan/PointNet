...
np.save(os.path.join(run_dir, 'training_losses'), np.array(training_losses))
np.save(os.path.join(run_dir, 'training_accuracies'), np.array(training_accuracies))
np.save(os.path.join(run_dir, 'test_accuracies'), np.array(test_losses))
